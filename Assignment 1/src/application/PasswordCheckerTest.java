...
public class PasswordCheckerTest {
	...
	public void setUp() throws Exception {
		...
		*/
		String[] q = {"556622KK", "YuAre@NtUgly", "tyreek4FFF", "2hun$", "jeremy78#", "award7%the", 
				"september23", "ghijkl", "6tyucc"};
		passwords = new ArrayList<String>();
		passwords.addAll(Arrays.asList(q));
	}
	...
	@Test
	public void testGetInvalidPasswordsSTUDENT() {
		ArrayList<String> result1;
		result1 = PasswordCheckerUtility.getInvalidPasswords(passwords);
		Scanner scan1 = new Scanner(result1.get(0));
		//assertEquals(scan1.next(), "556622kk");
		String theNextResults = scan1.nextLine().toLowerCase();
		//assertTrue(theNextResults.contains("lowercase"));
		scan1 = new Scanner(result1.get(1));
		assertEquals(scan1.next(), "YuAre@NtUgly");
		theNextResults = scan1.nextLine().toLowerCase();
		scan1 = new Scanner(result1.get(4));
	//	assertEquals(scan1.next(), "jeremy78#");
		theNextResults = scan1.nextLine().toLowerCase();
