...
public class NotationStackTest {
	...
	double first =1, second=22, third =10.5, fourth =0.22, fifth =13, sixth=19;
	@Before
	...
	public void testPopStudent() {
		...
		try {
			assertEquals(Double.valueOf(third), doubleS.pop());
			assertEquals(Double.valueOf(second), doubleS.pop());
			assertEquals(Double.valueOf(first), doubleS.pop());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testToStringStudent() throws StackOverflowException {
		//Use the doubleQ for student tests
		assertEquals("1.022.010.5", doubleS.toString());
		doubleS.push(fourth);
		assertEquals("1.022.010.50.22", doubleS.toString());
		doubleS.push(fifth);
		assertEquals("1.022.010.50.2213.0", doubleS.toString());
	}
